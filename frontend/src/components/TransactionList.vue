...
<template>
  <div class="bg-white shadow rounded-lg overflow-hidden">
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 text-left overflow-y-auto">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr v-for="transaction in transactions" :key="transaction.id" class="hover:bg-gray-50">
            <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-900">{{ transaction.date }}</td>
            ...
            <td class="px-6 py-1 whitespace-nowrap text-sm font-semibold text-gray-900 text-right">{{ formatCurrency(transaction.amount) }}</td>
            <td class="px-6 py-1 whitespace-nowrap text-sm text-gray-500">{{ transaction.payer }}</td>
